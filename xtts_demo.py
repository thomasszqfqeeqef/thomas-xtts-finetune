...
demo.launch(
    share=True,               # Lien public activé
    server_name="0.0.0.0",    # Utilisation de 0.0.0.0 pour Colab
    server_port=None          # Pas de port spécifié, Gradio choisit automatiquement
)
